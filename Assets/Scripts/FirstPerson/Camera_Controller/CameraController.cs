    ...
    public class CameraController : MonoBehaviour
    {
        ...
        #region BuiltIn Methods  
            ...
            private void Start()
            {
                ...
                sensitivity = new Vector2(PlayerPrefs.GetFloat("mouseSensivity"), PlayerPrefs.GetFloat("mouseSensivity")); 
                
            }

            public void ChangeCursorSensivity(float value)
            {
            ...
            public void ChangeCursorLockState(bool status)
            {
                ChangeCursorState(status);
            }
        ...
        #region Custom Methods
            ...
            void ChangeCursorState(bool status)
            {
                if (status)
                {
